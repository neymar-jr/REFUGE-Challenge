...
class DeepLabHeadV3Plus(nn.Module):
    def __init__(self, in_channels, low_level_channels, num_classes, aspp_dilate=[12, 24, 36]):
        ...
        # SENet
        # self.low_selayer = A.SELayer(in_dim=48, reduction=2, batch_first=True)
        # self.high_selayer = A.SELayer(in_dim=256, reduction=2, batch_first=True)
    ...
    def forward(self, feature):
        ...
        # low_level_feature = self.low_selayer(low_level_feature)
        ...
        # output_feature = self.high_selayer(output_feature)
...
if __name__=='__main__':
    ...
    # selayer1 = SENet.SELayer(channel = 48, reduction = 2, batch_first = True)
    # selayer2 = SENet.SELayer(channel = 256, reduction = 2, batch_first = True)
    # low_feature = selayer1(low_feature)
    # high_feature = selayer2(high_feature)

    # low_ca = CBAM.ChannelAttention(in_channels = 48, reduction = 4, batch_first = True)
    # low_pa = CBAM.SpatialAttention(kernel_size = 3, batch_first = True)
    # high_ca = CBAM.ChannelAttention(in_channels = 256, reduction = 4, batch_first = True)
    # high_pa = CBAM.SpatialAttention(kernel_size = 3, batch_first = True)
    # low_feature = low_ca(low_feature)
    # low_feature = low_pa(low_feature)
